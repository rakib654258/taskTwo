...
class CustomLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        for item in 0..<collectionView.numberOfItems(inSection: 0) {
            ...
            let contentSize = delegate.collectionView(collectionView, sizeOfContentAtIndexPath: indexPath)
            
            let cellWidth = columnWidth
            var cellHeight = contentSize.height * cellWidth / contentSize.width
